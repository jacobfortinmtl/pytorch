...
class TestNaNConv2dPy(unittest.TestCase):
    ...
    def test_no_nans(self): 
        ...
        for _ in range(n):
          ...
          conv = NaNConv2d(train=False, kernel=kernel, bias=None, padding=1, stride=1, threshold=1)
          nanoutput = conv(inputs)
          if not torch.isclose(nanoutput, output, rtol=5e-10).all(): fail += 1

        self.assertTrue(fail/n < self.nonan_fault_tolerance, f"NanConv no nans Test failed: Torch and NaNConv convolutions do not match for padding=1 and stride=1 for over {self.nonan_fault_tolerance*100}% of the time with a relative tolerance of 5e-10.")
        print(f"NanConv no nans Test passed: Torch and NaNConv convolutions match for padding=1 and stride=1 within relative tolerance of 5e-10 and disagree under {self.nonan_fault_tolerance*100}% of the time.")
        ...
        self.assertTrue(fail/n < self.nonan_fault_tolerance, f"NanConv no nans Test failed: Torch and NaNConv convolutions do not match for padding=0 and stride=1 for over {self.nonan_fault_tolerance*100}% of the time with a relative tolerance of 5e-10.")
        print(f"NanConv no nans Test passed: Torch and NaNConv convolutions match for padding=0 and stride=1 within relative tolerance of 5e-10 and disagree under {self.nonan_fault_tolerance*100}% of the time.")
        ...
        self.assertTrue(fail/n < self.nonan_fault_tolerance, f"NanConv no nans Test failed: Torch and NaNConv convolutions do not match for padding=1 and stride=3 for over {self.nonan_fault_tolerance*100}% of the time with a relative tolerance of 5e-10.")
        print(f"NanConv no nans Test passed: Torch and NaNConv convolutions match for padding=1 and stride=3 within relative tolerance of 5e-10 and disagree under {self.nonan_fault_tolerance*100}% of the time.")
    ...
    def test_mixed_nans(self):
        ...
        self.assertTrue(fail/n < self.mixed_fault_tolerance, f"NanConv mixed nan Test failed: Torch and NaNConv convolutions do not match for padding=1 and stride=3 for over {self.mixed_fault_tolerance*100}% of the time with a relative tolerance of 5e-10.")
        print(f"NanConv mixed nan Test passed: Torch and NaNConv convolutions match for padding=1 and stride=3 within relative tolerance of 5e-10 and disagree under {self.mixed_fault_tolerance*100}% of the time.")
...
class TestNaNConv2d(unittest.TestCase):
    ...
    def test_mixed_nans(self):
        ...
        fail = 0
        for i in range(n):
            if not torch.isclose(nan_output[i], default_output[i], rtol=5e-10).all(): fail += 1
        ...
        # Test conv output
        self.assertTrue(fail/n < self.mixed_fault_tolerance, f"NanConv mixed nan Test failed: Torch and NaNConv convolutions do not match for padding=1 and stride=3 for over {self.mixed_fault_tolerance*100}% of the time with a relative tolerance of 5e-10.")
        print(f"NanConv mixed nan Test passed: Torch and NaNConv convolutions match for padding=1 and stride=1 within relative tolerance of 5e-10 and disagree under {self.mixed_fault_tolerance*100}% of the time.")
    ...
    def test_no_nans(self): 
        ...
        # Test conv output
        self.assertTrue(fail/n < self.mixed_fault_tolerance, f"NanConv no nans Test failed: Torch and NaNConv convolutions do not match for padding=1 and stride=1 for over {self.nonan_fault_tolerance*100}% of the time with a relative tolerance of 5e-10.")
        print(f"NanConv no nans Test passed: Torch and NaNConv convolutions match for padding=1 and stride=1 within relative tolerance of 5e-10 and disagree under {self.nonan_fault_tolerance*100}% of the time.")
...
if __name__ == "__main__":
    ...
    # prep = PrepNaNConv2d(save_dir=save_dir)
