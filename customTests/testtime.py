...
if (os.environ.get('WRITE') == '1'):
    ...
    plt.plot(sizes1, times1, 'o-', label='Squash - Insert', markersize=4)  # Increase marker size here
    plt.plot(sizes3, times3, 'o-', label='Squash - No Insert', markersize=4)  # Increase marker size here
    plt.plot(sizes4, times4, 'o-', label='Squash - Sequential', markersize=4)  # Increase marker size here
    plt.plot(sizes2, times2, 'o-', label='Torch', markersize=4)  # Increase marker size here
